...
gene. Because LPWC aligns after recaling each sequence individually, we must filter out low-variance genes. I chose a filtering function of Var(x) / mean(x),
as choosing the highest variance genes merely chose the genes with very large expression values, and using the coefficient of variance selected the smallest. (Yury Bukhman suggested using the variance of the log values, I have not yet repeated with this strategy. )
